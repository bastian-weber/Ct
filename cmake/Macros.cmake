...
macro(copydlls OUTPUT_STRING MODULELIST)
	set(ALREADY_COPIED)
	foreach(ELEMENT ${${MODULELIST}})
		...
		list(FIND ALREADY_COPIED ${LOC_R} INDEX)
		if(${INDEX} EQUAL -1)
			list(APPEND ALREADY_COPIED ${LOC_R})
			string(CONCAT ${OUTPUT_STRING} ${${OUTPUT_STRING}} "\"${LOC_R}\" \"${CMAKE_CURRENT_BINARY_DIR}/Release\" ")
		endif()
		#file(COPY ${LOC_D} DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/Debug)
		list(FIND ALREADY_COPIED ${LOC_D} INDEX)
		if(${INDEX} EQUAL -1)
			list(APPEND ALREADY_COPIED ${LOC_D})
			string(CONCAT ${OUTPUT_STRING} ${${OUTPUT_STRING}} "\"${LOC_D}\" \"${CMAKE_CURRENT_BINARY_DIR}/Debug\" ")
		endif()
