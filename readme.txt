...
folder, then go to /build, then go either to /x64 or /x86, depending on whether you have a x64 or a x86 project, then go to /vc10/bin or /vc11/bin or /vc12/bin (depending on the verion of your Visual Studio). Here you choose the dlls
